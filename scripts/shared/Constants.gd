...
const WORLD_CONTAINER_KIND_LOOT_BAG := "loot_bag"
const DEFAULT_WORLD_CONTAINER_SPRITE := "res://tileset/decorations.png"
const DEFAULT_WORLD_CONTAINER_SPRITE_REGION := Rect2(0, 0, 32, 64)
