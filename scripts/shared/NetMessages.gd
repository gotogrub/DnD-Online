...
const C2S_REQUEST_PLAYER_LIST := "c2s_request_player_list"
const S2C_PLAYER_LIST := "s2c_player_list"
const C2S_GM_GIVE_ITEM_TO_CHARACTER := "c2s_gm_give_item_to_character"
const C2S_DROP_INVENTORY_ITEM := "c2s_drop_inventory_item"
